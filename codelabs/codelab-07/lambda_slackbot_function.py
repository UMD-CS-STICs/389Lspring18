...
def lambda_handler(data, context):
    ...
    # Slack users, which we want to process and handle,
    # and the responses generated by bots.
    is_user_msg = "bot_id" not in slack_event
    ...
    if is_user_msg:
        ...
        # TODO: Do something unique with the text the user has sent to your bot.
        # You can store your response in the `response_text` variable.
        # Recall in the demo we did in class, this consisted of reversing the text
        # from the user. You MUST implement something different from that :)
